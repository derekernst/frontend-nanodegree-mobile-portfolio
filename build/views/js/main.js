...
function updatePositions() {
  ...
  //var phaseHolder = currentScrollY/ 1250;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //You could optimize this for the screen size: screen.height & screen.width --> so you only load as many pizzas
  //as the screen will take
  for (var i = 0; i < 60; i++) {
